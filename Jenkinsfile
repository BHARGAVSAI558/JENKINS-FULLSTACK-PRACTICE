pipeline {
    ...
    steps {
        ...
        xcopy /E /I /Y FRONTEND\\fsdfrontend\\dist\\* "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\reactbookapi"
        '''
    }
}
        ...
        stage('Build Backend') {
            steps {
                dir('SPRINGBACKEND/SpringBackend') {
